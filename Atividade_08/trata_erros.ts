...
class ValorDepositoInvalido_Error extends AplicacaoError {
    constructor(mensagem: string) {
        super(mensagem)
    }
}

import { Banco, Conta, ContaImposto, Poupanca } from './Banco.js'
import prompt from 'prompt-sync'
const input = prompt()
export { ValorInvalido_Error, SaldoInsuficiente_Error, ContaInexistenteError , ValorDepositoInvalido_Error}